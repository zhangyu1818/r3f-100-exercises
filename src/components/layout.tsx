...
export const DefaultLayout = (props: DefaultLayoutProps) => {
  ...
  return (
    <div className={twMerge('size-full bg-zinc-100', className)}>
      {message && (
        <div className="absolute top-8 left-8 z-10 text-xl font-semibold mix-blend-difference">
          {message}
        </div>
      )}
      <Link
      ...
      <p className="absolute right-8 bottom-8 z-10 gap-1 text-end font-serif mix-blend-difference">
