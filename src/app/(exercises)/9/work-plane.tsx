...
import {
  createStretchWaveMaterial,
  type StretchWaveMaterialInstance,
} from './material'
import { getProjectedPlane } from './utils'

import type { WorkPlaneProps } from './types'

export function WorkPlane(props: WorkPlaneProps) {
  const {
    fluid,
    frostTexture,
    hoveredPreview,
  ...
  const materialRef = useRef<StretchWaveMaterialInstance | null>(null)

  if (materialRef.current === null) {
    materialRef.current = createStretchWaveMaterial({ texture })
  }
